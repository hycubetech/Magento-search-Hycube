<?php
/**
 * Hycubecompleteplus_Autosuggest_Adminhtml_Model_Button
 ...
 */
class Hycubecompleteplus_Autosuggest_Adminhtml_Model_Button extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
     * Set template
     * 
