...
class Hycubecompleteplus_Autosuggest_Model_Service
{
    public function populatePusher()
    {
        ...
        Mage::getResourceModel('hycubecompleteplus_autosuggest/pusher')->truncate();
        ...
        if ($inserts) {
            ...
            $tableName = $this->_getTable('hycubecompleteplus_autosuggest/pusher');
