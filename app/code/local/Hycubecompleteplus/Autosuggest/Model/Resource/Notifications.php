 ...
 */
class Hycubecompleteplus_Autosuggest_Model_Resource_Notifications extends Mage_Core_Model_Mysql4_Abstract
{
    protected function _construct()
    {
        $this->_init('hycubecompleteplus_autosuggest/notifications', 'notification_id');
    }
