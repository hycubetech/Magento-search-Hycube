 ...
 */
class Hycubecompleteplus_Autosuggest_Model_Resource_Fulltext_Collection extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection
{
    ...
    public function addSearchFilter($query)
    {
        if (!$this->is_layered_enabled) {
            ...
            $extension_version = Mage::helper('hycubecompleteplus_autosuggest')->getVersion();
