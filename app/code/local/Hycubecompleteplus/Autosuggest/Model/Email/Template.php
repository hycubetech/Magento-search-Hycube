...
/**
 * Hycubecompleteplus_Autosuggest_Model_Email_Template
 *
 * NOTICE OF LICENSE
 *
 * This source file is subject to the Open Software License (OSL 3.0)
 ...
 * @link      http://opensource.org/licenses/osl-3.0.php
 */
class Hycubecompleteplus_Autosuggest_Model_Email_Template extends Mage_Core_Model_Email_Template
{
    const HYCUBECOMPLETEPLUS_WEBHOOK_URI = 'https://0-1ms-dot-acp-magento.appspot.com/ma_webhook';//'https://acp-magento.appspot.com/ma_webhook';
