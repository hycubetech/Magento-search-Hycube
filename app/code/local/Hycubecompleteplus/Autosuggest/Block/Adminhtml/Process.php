<?php
/**
 * Hycubecompleteplus_Autosuggest_Block_Adminhtml_Process
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class Hycubecompleteplus_Autosuggest_Block_Adminhtml_Process extends Mage_Adminhtml_Block_System_Config_Form_Field
{
