<?php
/**
 * Hycubecompleteplus_Autosuggest_Block_Hycubecomplete
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class Hycubecompleteplus_Autosuggest_Block_Hycubecomplete extends Mage_Core_Block_Abstract
{
    protected function _toHtml()
    {
        ...
        try {
            ...
            Mage::log('hycubecomplete.php _toHtml() Exception => fulltext_enable and query calculations'.$e->getMessage(), null, 'hycubecompleteplus.log');
        ...
        if (!$is_full_text_wrong_flow) {
            try {
                ...
                Mage::log(
                    'hycubecomplete.php _toHtml() Exception => results_for and did you mean calculations'.$e->getMessage(),
                    null,
        ...
        $extension_version = (string) Mage::getConfig()
            ->getNode()
            ->modules
            ->Hycubecompleteplus_Autosuggest
            ->version;
