...
/**
 * Hycubecompleteplus_Autosuggest_Helper_Batches
 *
 * NOTICE OF LICENSE
 *
 * This source file is subject to the Open Software License (OSL 3.0)
 ...
 * @link      http://opensource.org/licenses/osl-3.0.php
 */
class Hycubecompleteplus_Autosuggest_Helper_Batches
{
        ...
        try {
            try {
                ...
                foreach ($product_stores as $product_store) {
                    $batches = Mage::getModel('hycubecompleteplus_autosuggest/batches')->getCollection()
                    ...
                    if ($batches->getSize() > 0) {
                        ...
                        $newBatch = Mage::getModel('hycubecompleteplus_autosuggest/batches');
        ...
        try {
            foreach ($product_stores as $product_store) {
                ...
                if ($updates && $updates->getSize() > 0) {
                    ...
                    $batch = Mage::getModel('hycubecompleteplus_autosuggest/batches');
