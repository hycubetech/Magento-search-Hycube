...
/**
 * Hycubecompleteplus_Autosuggest_Helper_Catalogsearch
 *
 * NOTICE OF LICENSE
 *
 * This source file is subject to the Open Software License (OSL 3.0)
 ...
 * @link      http://opensource.org/licenses/osl-3.0.php
 */
 class Hycubecompleteplus_Autosuggest_Helper_Catalogsearch extends Mage_CatalogSearch_Helper_Data
 {
     public function getResultUrl($query = null)
     {
         try {
             $layered = Mage::getStoreConfig('hycubecompleteplus/config/miniform_change');
         } catch (Exception $e) {
